[1.7.5.2. Update Tenant Certificate
[20](#_Toc170992504)](#_Toc170992504)

[1.7.5.3. Update Partner Certificate
[20](#_Toc170992505)](#_Toc170992505)

[2. References [21](#_Toc164443397)](#_Toc164443397)

1.  []{#_Toc164443332 .anchor}Introduction

\<Introduction in relevance to the context of "webMethods.io Integration
Operations in brief"\>

1.  Need enablement to access right data to take right action promptly
    in case of any issues.

2.  Also enabled to monitor and observe the state of the system with
    ease to ensure minimal to no impact to Business with Integrations
    hosted on Webmethods.io Integration.

This Guide serves as a handbook for consultants, and covers the
information required by operations team to be able to perform various
activities as part of Operations on day-to-day basis and on regular
basis on webmethods.io Integration Platform with minimal support by
Webmethods Cloud Ops, using the Out of the box product features after
completing this workshop.

2.  []{#_Toc170992469 .anchor}Operational Details

Below sections explain how each of the operational procedures listed can
be performed on webmethods.io Integration product.

3.  []{#_Toc170992470 .anchor}Tenant Management:

> Administration activities to keep the platform up to date with latest
> fixes as per releases by, SoftwareAG cloud operations team, including
> installing fixes, upgrades, user onboarding, modifying access
> privileges Super-user like access.
>
> This task includes discover tenant details with a tenant user created
> by SAG cloud Ops team while provisioning tenant.
>
> Tenant management covers information about Tenant profile and tenant
> type, Security management and Environments and Stage setup.

4.  []{#_Toc170992471 .anchor}Security Management:

> Keep tenants safe from unprivileged users, by providing required and
> limited access to tenant and its assets.

**[For various tasks to be performed by operations team for Tenant
Management and Security Management, step by step information is detailed
in the sections referenced below:]{.underline}**
  ...
  **Tenant profile                                
  ...
  1                How to identify tenant type    Detailed in section 3.1 and 3.2 of Tenant Management -
                   and tenant version?            PRIME Guide -
                                                  webMethods.IO_Integration_Operations_ManualPart1.docx

  2                How to verify tenant profile   
                   like subscription plan         
                   details? -- If required to     
                   upgrade.                       
  ...
  **Security                                      
  ...
  3                List of activities of tenant   Detailed in section 3.3 of Tenant Management - PRIME
                   users, various roles (system   Guide -
                   defined)                       webMethods.IO_Integration_Operations_ManualPart1.docx

  4                What is the System defined     
                   roles and their activities     

  5                How to create custom roles,    
                   what permissions to be defined 
                   and how to define custom roles 

  6                How to add roles to users      
                   while creating users and to    
                   associate users to projects    
                   for deployments                

  7                What is the System defined     
                   roles and activities performed 
                   with this role                 

  8                What permissions a tenant user 
                   for User management?           
  ...
  **Environments                                  
  ...
  9                What are the activities        Detailed in section 4 - Manage Environments and
                   involved to manage             Stages - PRIME Guide -
                   environments/stages?           webMethods.IO_Integration_Operations_ManualPart1.docx

  10               As part of manage              
                   environments, how to register  
                   and enable tenants to deploy   
                   assets from non-prod tenant?   

  11               How to create prod environment 
                   with prod tenant provisioned?  

  12               Allowing users to access       
                   environment?                   

  13               How to link environment to     
                   deploy assets from tenant of   
                   non-prod environment to prod   
                   tenant registered in Prod      
                   environment?                   

  14               How to update environment?     

  15               How to delete environment?     

  16               What are stages, How to Create 
                   Stages, why stages must be     
                   created?                       

  **How to Know?**                                

  12               How to check status of the     Detailed in section 5 - Truoble shooting- PRIME Guide -
                   tenant?                        webMethods.IO_Integration_Operations_ManualPart1.docx

  13               How to check status of tenants 
                   across regions?                

  14               How to identify IP address of  
                   the tenant?                    
  -------------------------------------------------------------------------------------------------------

5.  []{#_Toc170992472 .anchor}Operational Monitoring:

> When setting up monitoring, there are two things that one wants
> monitoring to help operations' team answer: **what is broken and
> why**. In other words, you want to monitor the logs, dashboards etc.,
> that indicate symptoms and their potential causes of failure
> occurrences.

Operations team can monitor logs from **Monitor** tab on webmethods.io
Integration page to understand the statistics of associated with
workflows and flowservices.

Webmethods.io Integration has two types of execution logs for analysis:

6.  []{#_Toc167975203 .anchor}[Execution results:]{.underline}

These logs display statistics associated with the workflow executions
and Flow service executions.

7.  []{#_Toc167975204 .anchor}[Workflow Execution results:]{.underline}

8.  []{#_Toc167975205 .anchor}Workflow Execution results dashboard:

> These logs display statistics associated with **execution of
> workflows** as in below dashboard.
>
> ![A screenshot of a computer Description automatically
> generated](vertopal_db61f758c50740318d93c5d237968a48/media/image2.png){width="5.649391951006124in"
> height="3.033333333333333in"}

9.  []{#_Toc167975206 .anchor}Workflow Execution results Status:
...
10. []{#_Toc167975207 .anchor}Resume and restart workflows:
...
11. []{#_Toc167975208 .anchor}Download Logs:

> Logs with selected date range can be downloaded in **csv or json
> format** in Work Flow execution Dashboard Section.
>
> ![A screenshot of a graph Description automatically
> generated](vertopal_db61f758c50740318d93c5d237968a48/media/image3.png){width="5.668947944006999in"
> height="3.0310476815398073in"}

12. []{#_Toc167975209 .anchor}[Flow Service Execution
    > Results:]{.underline}

13. []{#_Toc167975210 .anchor}Flow Service Execution Results Dashboard:

> These logs display statistics associated with **execution of flow
> services** as in below dashboard.
>
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image4.png){width="6.574305555555555in"
> height="2.902083333333333in"}

14. []{#_Toc167975211 .anchor}Flow Service Execution Results Status:
...
15. []{#_Toc167975212 .anchor}Download Logs:

> Logs with selected date range can be downloaded in csv or Json format
> in Flow service execution Dashboard Section.
>
> ![A screenshot of a computer Description automatically
> generated](vertopal_db61f758c50740318d93c5d237968a48/media/image5.png){width="5.766022528433946in"
> height="3.308333333333333in"}

16. []{#_Toc167975213 .anchor}Availability of Execution Results:
...
17. []{#_Toc167975214 .anchor}[Audit logs:]{.underline}
...
![A screenshot of a computer Description automatically
generated](vertopal_db61f758c50740318d93c5d237968a48/media/image6.png){width="6.574305555555555in"
height="2.576388888888889in"}

![](vertopal_db61f758c50740318d93c5d237968a48/media/image7.png){width="6.558333333333334in"
height="2.5in"}
...
18. []{#_Toc167975215 .anchor}End to End Monitoring
...
19. []{#_Toc167975216 .anchor}License Type
...
20. []{#_Toc167975217 .anchor}Custom Domain
...
21. []{#_Toc167975218 .anchor}How It Works
...
22. []{#_Toc167975219 .anchor}Subdomain Name Prerequisites
...
23. []{#_Toc167975220 .anchor}Steps to configure custom domains
...
<!-- -->
```
24. []{#_Toc167975221 .anchor}Dashboard
...
>
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image8.png){width="3.1166666666666667in"
> height="2.6998950131233594in"}
>
> **[Default view of Dashboard:]{.underline}**
>
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image9.png){width="6.158333333333333in"
> height="2.6083333333333334in"}
>
> For more Information:
> <https://docs.webmethods.io/e2e/using_e2e/dashboard_alerts/#co-dashboard>

25. []{#_Toc167975222 .anchor}Alerts
...
26. []{#_Toc167975223 .anchor}Data Analysis: Insights
...
27. []{#_Toc170992494 .anchor}Incident Management:
...
28. []{#_Toc167975195 .anchor}Configure Alert Rules

29. []{#_Toc167975196 .anchor}Workflow Alerts

30. []{#_Toc167975197 .anchor}Adding Workflow Alerts
...
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image10.png){width="6.574305555555555in"
> height="1.35in"}

2.  Click on the **[Add Alert]{.underline}** button located at the right
    of the screen to create a new alert rule.

> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image11.png){width="6.379166666666666in"
...
>
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image12.png){width="6.574305555555555in"
...
<!-- -->
```
31. []{#_Toc167975199 .anchor}FlowService Alerts
...
32. []{#_Toc167975200 .anchor}Adding flowservice alerts
...
![](vertopal_db61f758c50740318d93c5d237968a48/media/image13.png){width="6.860416666666667in"
height="1.966560586176728in"}
...
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image14.png){width="6.574305555555555in"
> height="1.9506944444444445in"}

3.  Add details as below:

> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image15.png){width="4.408333333333333in"
> height="3.7in"}
...
<!-- -->
```
33. []{#_Toc170992500 .anchor}Deployment Considerations
...
<!-- -->
```
34. []{#_Toc170992501 .anchor}Tenant Maintenance:
...
35. []{#_Toc170992502 .anchor}Maintenance of renewable assets:
...
<!-- -->
```
36. []{#_Toc170992503 .anchor}Update User Certificate
...
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image16.png){width="6.574305555555555in"
...
> ![A screenshot of a computer Description automatically
> generated](vertopal_db61f758c50740318d93c5d237968a48/media/image17.png){width="4.9847222222222225in"
> height="2.6083333333333334in"}

37. []{#_Toc170992504 .anchor}Update Tenant Certificate
...
> ![](vertopal_db61f758c50740318d93c5d237968a48/media/image18.png){width="6.333333333333333in"
> height="2.1083333333333334in"}

38. []{#_Toc170992505 .anchor}Update Partner Certificate
...
<!-- -->
```
39. []{#_Toc164443397 .anchor}References
...
| enable the digital real-time enterprise. Software AG offers the first |
| end-to-end Digital Business Platform, based on open standards, with   |
| integration, process management, in-memory data, adaptive application |
| development, real-time analytics and enterprise architecture          |
| management as core building blocks. The modular platform allows users |
| to develop the next generation of application systems to build their  |
| digital future, today. With over 45 years of customer-centric         |
| innovation, Software AG is ranked as a leader in many innovative and  |
| digital technology categories. Learn more at www.SoftwareAG.com.      |
|                                                                       |
| © Software AG. All rights reserved. Software AG and all Software AG   |
| products are either trademarks or registered trademarks of Software   |
| AG. Other product and company names mentioned herein may be the       |
| trademarks of their respective owners                                 |
+=======================================================================+
| ![](vertopal_db61f758c50                                              |
| 740318d93c5d237968a48/media/image19.wmf){width="1.4763779527559056in" |
| height="0.2283464566929134in"}                                        |
+-----------------------------------------------------------------------+
